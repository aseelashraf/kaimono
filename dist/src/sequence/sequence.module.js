...
const sequence_model_1 = require("./sequence.model");
const sequence_service_1 = require("./sequence.service");
let SequenceModule = class SequenceModule {
};
SequenceModule = __decorate([
    common_1.Module({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: 'Sequence', schema: sequence_model_1.SequenceSchema }])
        ],
